...
def vol_create_delete_test():
    ...
    subprocess.call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    cmd_opts = "--gtest_filter=VolTest.recovery_io_test --create_del_with_io=true --delete_volume=0 --run_time=600 --create_del_ops_interval=600 --verify_type=2 --expect_io_error=1 --remove_file=1"
    subprocess.check_call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    print("homestore create first cp test completed")

    # abort during vol delete before writing meta blk
    cmd_opts = "--mod_list=\"index\" --create_del_with_io=true --gtest_filter=VolTest.init_io_test --free_blk_cnt=50 --indx_del_partial_free_data_blks_before_meta_write=true --run_time=10000 --max_num_writes=1000000 --create_del_ops_interval=300 --max_volume=3 --num_threads=1 --verify_type=3 --expect_io_error=1 --remove_file=0"
    subprocess.call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    cmd_opts = "--gtest_filter=VolTest.recovery_io_test --create_del_with_io=true --max_volume=3 --run_time=600 --create_del_ops_interval=600 --verify_type=3 --expect_io_error=1 --remove_file=1"
    subprocess.check_call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    print("abort during vol delete before writing meta blk test compeleted")
    
    # abort during vol delete after writing meta blk
    cmd_opts = "--mod_list=\"index\" --create_del_with_io=true --gtest_filter=VolTest.init_io_test --free_blk_cnt=50 --indx_del_partial_free_data_blks_after_meta_write=true --run_time=10000 --max_num_writes=1000000 --create_del_ops_interval=300 --max_volume=3 --num_threads=1 --verify_type=3 --expect_io_error=1 --remove_file=0"
    subprocess.call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    cmd_opts = "--gtest_filter=VolTest.recovery_io_test --create_del_with_io=true --max_volume=3 --run_time=600 --create_del_ops_interval=600 --verify_type=3 --expect_io_error=1 --remove_file=1"
    subprocess.check_call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    ...
    cmd_opts = "--mod_list=\"index\" --create_del_with_io=true --gtest_filter=VolTest.init_io_test --free_blk_cnt=50 --indx_del_partial_free_indx_blks=true --run_time=10000 --max_num_writes=1000000 --create_del_ops_interval=300 --max_volume=3 --num_threads=1 --verify_type=3 --expect_io_error=1 --remove_file=0"
    subprocess.call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    cmd_opts = "--gtest_filter=VolTest.recovery_io_test --create_del_with_io=true --max_volume=3 --run_time=600 --create_del_ops_interval=600 --verify_type=3 --expect_io_error=1 --remove_file=1"
    subprocess.check_call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    ...
    cmd_opts = "--mod_list=\"index\" --create_del_with_io=true --gtest_filter=VolTest.init_io_test --free_blk_cnt=50 --indx_del_free_blks_completed=true --run_time=10000 --max_num_writes=1000000 --create_del_ops_interval=300 --max_volume=3 --num_threads=1 --verify_type=3 --expect_io_error=1 --remove_file=0"
    subprocess.call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    cmd_opts = "--gtest_filter=VolTest.recovery_io_test --create_del_with_io=true --max_volume=3 --run_time=600 --create_del_ops_interval=600 --verify_type=3 --expect_io_error=1 --remove_file=1"
    subprocess.check_call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    ...
    cmd_opts = "--mod_list=\"index\" --create_del_with_io=true --gtest_filter=VolTest.init_io_test --free_blk_cnt=50 --indx_del_partial_free_data_blks_before_meta_write=true --run_time=10000 --max_num_writes=1000000 --create_del_ops_interval=300 --max_volume=3 --num_threads=1 --verify_type=3 --expect_io_error=1 --remove_file=0"
    subprocess.call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    cmd_opts = "--mod_list=\"index\" --create_del_with_io=true --gtest_filter=VolTest.recovery_io_test --free_blk_cnt=50 --indx_del_partial_free_data_blks_before_meta_write=true --run_time=10000 --max_num_writes=1000000 --create_del_ops_interval=300 --max_volume=3 --num_threads=1 --verify_type=3 --expect_io_error=1 --remove_file=0"
    subprocess.call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
    cmd_opts = "--gtest_filter=VolTest.recovery_io_test --create_del_with_io=true --max_volume=3 --run_time=600 --create_del_ops_interval=600 --verify_type=3 --expect_io_error=1 --remove_file=1"
    subprocess.check_call(dirpath + "test_volume " + cmd_opts + addln_opts, shell=True)
