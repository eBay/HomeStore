...
public:
    ...
    virtual bool inc_hs_ref_cnt(boost::uuids::uuid& uuid) override;
    virtual bool dec_hs_ref_cnt(boost::uuids::uuid& uuid) override;
    virtual bool fault_containment(boost::uuids::uuid& uuid) override;
