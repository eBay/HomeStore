...
//#define LoadGenSSDBtree  Btree<btree_store_type::SSD_BTREE, K, V, btree_node_type::VAR_VALUE, btree_node_type::VAR_VALUE, NodeSize, writeback_req>

#define LoadGenSSDBtree  Btree<btree_store_type::SSD_BTREE, K, V, find_interior_node_type<K>(), find_leaf_node_type<K, V>(), NodeSize, writeback_req>
...
public:   
    static boost::intrusive_ptr< ssd_loadgen_req > make_request() {
        return boost::intrusive_ptr< ssd_loadgen_req >(homeds::ObjectAllocator< ssd_loadgen_req >::make_object());
            
    }

    virtual void free_yourself() override { homeds::ObjectAllocator< ssd_loadgen_req >::deallocate(this); }
    ...
    protected:
    friend class homeds::ObjectAllocator< ssd_loadgen_req >;
};
