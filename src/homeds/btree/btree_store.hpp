...
#define BtreeSpecificImplDeclType BtreeSpecificImpl< BtreeType, K, V, InteriorNodeType, LeafNodeType, NodeSize, btree_req_type >
...
class BtreeStore {
    ...
    //using btree_node_t = BtreeNode<BtreeType, K, V, InteriorNodeType, LeafNodeType, NodeSize, btree_req_type>;
...
public:
    ...
    static boost::intrusive_ptr<btree_node_t> alloc_node(BtreeSpecificImplDeclType *impl, bool is_leaf);
    static boost::intrusive_ptr<btree_node_t> read_node(BtreeSpecificImplDeclType *impl, bnodeid_t id);
    static void write_node(BtreeSpecificImplDeclType *impl, 
                           boost::intrusive_ptr<btree_node_t> bn,
    ...
    static void read_node_lock(BtreeSpecificImplDeclType *impl, 
                               boost::intrusive_ptr<btree_node_t> bn, bool is_write_modifiable,
                               std::deque<boost::intrusive_ptr<btree_req_type>> *dependent_req_q);
