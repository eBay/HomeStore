...
size_t homestore::HS_STATIC_CONFIG(disk_attr.align_size) = 8192;
size_t homestore::HS_STATIC_CONFIG(generic.min_io_size) = 8192;
size_t homestore::HomeStoreConfig::mem_btree_page_size = 8192;
uint64_t homestore::HS_STATIC_CONFIG(generic.max_chunks) = MAX_CHUNKS;
uint64_t homestore::HS_STATIC_CONFIG(generic.max_vdevs) = MAX_VDEVS;
uint64_t homestore::HS_STATIC_CONFIG(generic.max_pdevs) = MAX_PDEVS;
