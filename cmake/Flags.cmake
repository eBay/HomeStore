        ...
        if(DEFINED configurations)
            foreach(configuration ${configurations})
                ...
                if(NOT CMAKE_${upper_language}_FLAGS_${upper_configuration})
                    set(CMAKE_${upper_language}_FLAGS_${upper_configuration} "${Flags}" PARENT_SCOPE) 
                else()
                    set(CMAKE_${upper_language}_FLAGS_${upper_configuration} 
                        "${CMAKE_${upper_language}_FLAGS_${upper_configuration}} ${Flags}" PARENT_SCOPE)
                endif()
            endforeach()
        else()
            if(NOT CMAKE_${upper_language}_FLAGS)
                set(CMAKE_${upper_language}_FLAGS "${Flags}" PARENT_SCOPE)
            else()
                set(CMAKE_${upper_language}_FLAGS "${CMAKE_${upper_language}_FLAGS} ${Flags}" PARENT_SCOPE)
            endif()
        endif()
    endforeach()    
